				...
				<div class="sugget_left sugget_right">
					<div class="show_option">
						...
						<ul class="content mCustomScrollbar">
							...
							?>
							<li onclick="get_product2('<?php echo $allproducts['proid']; ?>')"><img src="<?php get_image($allproducts['image_code']); ?>" alt="<?php echo $allproducts['pro_name']; ?>" width="92" height="92" id="countButton_<?php echo $allproducts['proid']; ?>" /></li>
							<?php } } ?>	
						</ul>
					</div>
				</div>
